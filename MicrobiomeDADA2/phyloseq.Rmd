...
#number of shared ASVs body.site (found in 25% of more)
```{r}
bodysite=ps_venn(
  physeqprune,
  "body.site", 
...
#Bray Curtis Subject Stats
```{r}
adonis2(dist ~ sample_data(physeqprune)$subject)
```

#Bray Curtis Body Site Stats:
```{r}
...
#look at the p values on top right
```

#Bray Curtis antibiotic usage
```{r}
